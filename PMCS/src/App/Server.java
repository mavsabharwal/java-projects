...
public class Server {
	...
	private static JTextArea txtrHi;
	...
	public static void main(String[] args) {
		...
		try {
			...
			s=skt.accept();
			lblAwatingConnection.setText("Connected");
			
			scrollPane = new JScrollPane();
			scrollPane.setBounds(10, 23, 303, 395);
			frame.getContentPane().add(scrollPane);
			
			txtrHi = new JTextArea();
			txtrHi.setForeground(Color.CYAN);
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				dout.writeUTF(msgop);
				textField.setText("");
				txtrHi.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
				txtrHi.setForeground(Color.PINK);
				txtrHi.append(msgop+"\n");				}
				catch(Exception ex) {}
